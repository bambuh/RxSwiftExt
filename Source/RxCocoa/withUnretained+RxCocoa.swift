...
extension SharedSequence {
    ...
    public func withUnretained<T: AnyObject, Out>(_ obj: T,
                                                  resultSelector: @escaping (T, E) -> Out?) -> SharedSequence<S, Out> {
        return map { [weak obj] element -> Out? in
            guard let obj = obj else {
                return nil
//                throw UnretainedError.failedRetaining
     ...
     */
    public func withUnretained<T: AnyObject>(_ obj: T) -> SharedSequence<S, (T, E)> {
